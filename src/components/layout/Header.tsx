...
const toolLinks = [
  ...
  { title: "Glossary Flashcards", href: "/tools/glossary-flashcards", description: "Spaced repetition learning", icon: Layers, isNew: true },
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background backdrop-blur-xl">
      <div className="container flex h-16 sm:h-20 items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden lg:flex items-center gap-2">
          <Button variant="outline" size="sm" className="border-copper/40 text-copper hover:bg-copper/10" asChild>
